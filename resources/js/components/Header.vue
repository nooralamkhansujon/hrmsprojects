        ...
        <!-- <li class="nav-item dropdown dropdown-cart mr-25">
          ...
          <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
            ...
            <li class="dropdown-menu-footer">
              ...
              <a class="btn btn-primary btn-block" href="app-ecommerce-checkout.html"
                >Checkout</a
              >
            </li>
          </ul>
        ...
        <li class="nav-item dropdown dropdown-user">
          ...
          >
            <div class="user-nav d-sm-flex d-none">
              <span class="user-name font-weight-bolder"> {{ authUser?.username }} </span
  ...
  <ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion">
      ...
      >
        <div class="d-flex">
          <div class="mr-75">
            <img src="/images/icons/doc.png" alt="png" height="32" />
          </div>
          <div class="search-data">
