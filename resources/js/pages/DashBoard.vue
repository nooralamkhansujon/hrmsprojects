        ...
        <div class="row match-height">
            ...
            <div class="col-xl-4 col-md-6 col-12">
                <div class="card card-congratulation-medal">
                    <div class="card-body">
                        <h5>Congratulations 🎉 Nooralam khan!</h5>
                        <p class="card-text font-small-3">You have won silver medal</p>
                        <h3 class="mb-75 mt-2 pt-50">
                            <a href="javascript:void(0);">$48.9k</a>
                        </h3>
                        <button type="button" class="btn btn-primary">View Sales</button>
                        <img src="/images/illustration/badge.svg" class="congratulation-medal"
                            alt="Medal Pic" />
                    </div>
                </div>
            </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="/images/icons/toolbox.svg"
                                                            alt="Toolbar svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="/images/icons/parachute.svg"
                                                            alt="Parachute svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="/images/icons/speaker.svg"
                                                            alt="Speaker svg" />
                                                    </div>
                                                </div>
                                                <div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="card card-developer-meetup">
                    <div class="meetup-img-wrapper rounded-top text-center">
                        <img src="/images/illustration/email.svg" alt="Meeting Pic"
                            height="170" />
                    </div>
                    <div class="card-body">
                        ...
                        <div class="avatar-group">
                            <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                ...
                                <img src="/images/portrait/small/avatar-s-9.jpg" alt="Avatar"
                                    width="33" height="33" />
                            </div>
                            <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                data-original-title="Amy Carson" class="avatar pull-up">
                                <img src="/images/portrait/small/avatar-s-6.jpg" alt="Avatar"
                                    width="33" height="33" />
                            </div>
                            <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                data-original-title="Brandon Miles" class="avatar pull-up">
                                <img src="/images/portrait/small/avatar-s-8.jpg" alt="Avatar"
                                    width="33" height="33" />
                            </div>
                            <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                data-original-title="Daisy Weber" class="avatar pull-up">
                                <img src="/images/portrait/small/avatar-s-20.jpg" alt="Avatar"
                                    width="33" height="33" />
                            </div>
                            <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                ...
                <div class="card card-browser-states">
                    ...
                    <div class="card-body">
                        <div class="browser-states">
                            <div class="media">
                                <img src="/images/icons/google-chrome.png" class="rounded mr-1"
                        ...
                        <div class="browser-states">
                            <div class="media">
                                <img src="/images/icons/mozila-firefox.png" class="rounded mr-1"
                        ...
                        <div class="browser-states">
                            <div class="media">
                                <img src="/images/icons/apple-safari.png" class="rounded mr-1"
                        ...
                        <div class="browser-states">
                            <div class="media">
                                <img src="/images/icons/internet-explorer.png"
                        ...
                        <div class="browser-states">
                            <div class="media">
                                <img src="/images/icons/opera.png" class="rounded mr-1"
